...
class BeritaTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        Alamofire.request("http://localhost/Aplikasiberita/index.php/api/getBerita").responseJSON{ (responseData) -> Void in
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.labelKategori.text = dict["id_cat"] as? String
        cell.labelIsi.text = dict["isi_berita"] as? String
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        kategoriSelected = task["id_cat"] as! String
